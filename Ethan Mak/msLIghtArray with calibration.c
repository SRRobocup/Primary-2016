#pragma config(Sensor, S2,     MSLSA,         sensorI2CCustomFastSkipStates9V)
...
task main()
{
	...
	displayTextLine(5,"Put on White and press enter");
	...
	displayTextLine(5,"Put on Black and press enter");
	while (nNxtButtonPressed==-1)
	{sleep(50);}
	...
	while (true) {
		...
		writeDebugStreamLine("%d %d %d %d %d %d %d %d",signalstr[0],signalstr[1],signalstr[2],signalstr[3],signalstr[4],signalstr[5],signalstr[6],signalstr[7]);
		sleep(50);
	}
}
